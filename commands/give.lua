...
function command.run(message, mt)
  ...
  local giftedmessage = formatstring(lang.gifted_message, {numcards, cdb[curfilename].name, uj2.id}, lang.plural_s)
  local recievedmessage = formatstring(lang2.recieved_message, {uj.id, numcards, cdb[curfilename].name}, lang2.plural_s)
